package com.gurukulams.starter.security.oauth2.service;
...
import com.gurukulams.starter.security.oauth2.user.OAuth2UserInfo;
import com.gurukulams.starter.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(final
        ...
        if (oAuth2UserInfo.getEmail() == null
                || oAuth2UserInfo.getEmail().isBlank()) {
